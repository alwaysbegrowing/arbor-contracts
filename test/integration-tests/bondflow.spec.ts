...
import { deployNativeAndPayment, createBond, initiateAuction } from "../setup";
...
//   it.only("should create erc20 tokens and bonds", async () => {
...
//     console.log(signer.address, await bond.balanceOf(signer.address))
